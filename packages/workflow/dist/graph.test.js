...
test("bfs with a single node", async () => {
    ...
    const dag = (0, graph_1.newDAG)({ actions: [node], edges: [edge], });
    let hits = 0;
    await (0, graph_1.bfs)(dag, async (n, e) => {
        hits++;
...
test("bfs with a tree single node", async () => {
    ...
    let hits = 0;
    await (0, graph_1.bfs)(dag, async (n, _e) => {
